WoWJapanizerBuffToolTip = WoWJapanizerToolTip:New("WoWJapanizerBuffToolTip")
WoWJapanizerBuffToolTip.Tooltip = WoWJapanizerAssistTooltip

WoWJapanizerBuffToolTip.BuffList = {};
WoWJapanizerBuffToolTip.BuffStore = nil

function WoWJapanizerBuffToolTip:OnEnable()
...
function WoWJapanizerBuffToolTip:OnShow(button)
    ...
    local spell = WoWJapanizer_Spell:GetBuffTooltipText(spellID, GameTooltip)
    if spell then
...
function WoWJapanizerBuffToolTip:OnHide(button)
