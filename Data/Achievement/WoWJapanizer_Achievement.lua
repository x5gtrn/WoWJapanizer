WoWJapanizer_Achievement = { }

function WoWJapanizer_Achievement:Get(id)
...
function WoWJapanizer_Achievement:GetID_ItemRefTooltip(tooltip)
...
function WoWJapanizer_Achievement:GetID_Side(side, index)
